...
HashMap<_K, _V, _H>::HashMap() : _ht(100) {}

template <typename _K, typename _V, typename _H>
HashMap<_K, _V, _H>::HashMap(size_type __n) : _ht(__n) {}

template <typename _K, typename _V, typename _H>
typename HashMap<_K, _V, _H>::size_type HashMap<_K, _V, _H>::size() const {
    return _ht.size();
}

template <typename _K, typename _V, typename _H>
bool HashMap<_K, _V, _H>::empty() const {
    return _ht.empty();
}

template <typename _K, typename _V, typename _H>
typename HashMap<_K, _V, _H>::iterator HashMap<_K, _V, _H>::begin() {
    return _ht.begin();
}

template <typename _K, typename _V, typename _H>
typename HashMap<_K, _V, _H>::iterator HashMap<_K, _V, _H>::end() {
    return _ht.end();
}
...
template <typename _K, typename _V, typename _H>
_V &HashMap<_K, _V, _H>::operator[](const key_type &__key) {
...
template <typename _K, typename _V, typename _H>
void HashMap<_K, _V, _H>::clear() {
    _ht.clear();
}

template <typename _K, typename _V, typename _H>
void HashMap<_K, _V, _H>::resize(size_type __hint) {
    _ht.resize(__hint);
}
