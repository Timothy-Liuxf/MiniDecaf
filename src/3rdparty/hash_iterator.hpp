...
template <typename _K, typename _V, typename _H>
bool _HashIterator<_K, _V, _H>::operator==(const iterator &__it) const {
...
template <typename _K, typename _V, typename _H>
_HashIterator<_K, _V, _H> &_HashIterator<_K, _V, _H>::operator++() {
...
template <typename _K, typename _V, typename _H>
inline _HashIterator<_K, _V, _H> _HashIterator<_K, _V, _H>::operator++(int) {
    iterator __tmp = *this;
    ++*this;
    return __tmp;
}
