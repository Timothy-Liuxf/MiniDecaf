...
template <typename _K, typename _V, typename _H>
typename HashTable<_K, _V, _H>::_Node *HashTable<_K, _V, _H>::_get_node() {
    return _node_allocator.allocate(1);
}

template <typename _K, typename _V, typename _H>
void HashTable<_K, _V, _H>::_put_node(_Node *__p) {
...
template <typename _K, typename _V, typename _H>
void HashTable<_K, _V, _H>::_delete_node(_Node *__n) {
...
template <typename _K, typename _V, typename _H>
typename HashTable<_K, _V, _H>::size_type HashTable<_K, _V, _H>::size() const {
    return _num_elements;
}

template <typename _K, typename _V, typename _H>
bool HashTable<_K, _V, _H>::empty() const {
    return 0 == size();
}

template <typename _K, typename _V, typename _H>
typename HashTable<_K, _V, _H>::iterator HashTable<_K, _V, _H>::begin() {
...
template <typename _K, typename _V, typename _H>
typename HashTable<_K, _V, _H>::iterator HashTable<_K, _V, _H>::end() {
...
HashTable<_K, _V, _H>::find(const key_type &__key) {
    ...
    _Node *p;
    for (p = _buckets[n]; (NULL != p) && (p->_val.first != __key); p = p->_next)
        ;
...
template <typename _K, typename _V, typename _H>
void HashTable<_K, _V, _H>::resize(size_type __at_least) {
